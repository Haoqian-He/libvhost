...
//void vhost_vq_init_split(struct libvhost_virt_queue* vq, struct libvhost_ctrl* ctrl);
//void vhost_vq_init_packed(struct libvhost_virt_queue* vq, struct libvhost_ctrl* ctrl);
